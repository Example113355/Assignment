...
void tc3() {
    ...
    ConcatStringList s3 = (*s0).concat(*s1);


    cout << "s3: " << (s3).toString() << endl;
    //ConcatStringList s4 = (*s2).subString(4, 4);
    //ConcatStringList s5 = (*s0).subString(7, 1);
    ConcatStringList s6 = (*s0).subString(2, 8);
    cout << "s6: " << (s6).toString() << endl;

    //ConcatStringList s7 = (s6).subString(6, 1);
    ConcatStringList s8 = (s6).subString(1, 3);
    cout << "s8: " << (s8).toString() << endl;

    //ConcatStringList s9 = (*s0).subString(1, 1);
    //ConcatStringList s10 = (*s2).subString(5, 4);
